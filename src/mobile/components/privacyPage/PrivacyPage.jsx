...
const PrivacyPage = () => (
  <PageWrapper>
    ...
    <PageBody>
      <PageBodyParagraph>
        At UW Flow, accessible from uwflow.com, one of our main priorities is
        the privacy of our visitors. This Privacy Policy document outlines
        information we collected and how we use it. If you have additional
        questions or require more information about our Privacy Policy, do not
        hesitate to contact us through email at info@uwflow.com.
      </PageBodyParagraph>
      <PageBodyHeader>Log Files</PageBodyHeader>
      <PageBodyParagraph>
        UW Flow follows a standard procedure of using log files. These files log
        ...
        the website, and gathering demographic information. If you choose to
        upload a transcript, we do not store any information related to marks or
        GPA. If you should choose to upload a schedule, we will store its
        associated information.
      </PageBodyParagraph>
      <PageBodyHeader>Cookies and Web Beacons</PageBodyHeader>
      <PageBodyParagraph>
        Like any other website, UW Flow uses 'cookies'. These cookies are used
      ...
      <PageBodyParagraph>
        ...
        Policies and their links here: facebook.com/about/privacy,
        policies.google.com/privacy. You can choose to disable cookies through
        your individual browser options. More detailed information regarding
      ...
      <PageBodyParagraph>
        UW Flow does not knowingly collect any Personal Identifiable Information
