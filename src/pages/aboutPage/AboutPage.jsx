...
const Contributor = ({ name, about, gh}) => (
    <li>
      <ContributorLink href={about} target="_blank">{name}</ContributorLink> — <ContributorLink href={`https://github.com/UWFlow/rmc/commits/master?author=${gh}`} target="_blank">contributions</ContributorLink>
    </li>
);
    ...
    <PageContentWrapper>
      <PageBody>
        ...
        <PageBodyParagraph>
          ...
          <br />
          <br />
          <i><b>"It’s like doing taxes. Each time, it’s inevitable, and each time, it’s
          ...
          that’s both incomplete and inconvenient."</b></i>
          <br />
          <br />
          Want to learn more? Check out <a
            href="http://david-hu.com/2014/02/28/open-sourcing-uw-flow-draft.html"
            target="_blank"
            rel="noopener noreferrer"
          >
            this blog post
          </a> for a tale of four tenacious students and one mammoth idea.
          <br />
          <br />
        ...
        <PageBodyParagraph>
          ...
          <TeamMember
            ...
            photo={BobImg}
          >
            Bob Wei is a backend developer working on UW Flow. In his free time, he can be found balling, running, or eating hot-pot.
            <br/><br/>
            He has worked at Uber ATG and SideFX and is interested in computer vision and general ML. You may also find him at grad school in a few years time.
          </TeamMember>
          <TeamMember
            name="Derrek Chow"
            title="Designer"
        ...
        <PageBodyParagraph>
          ...
          >
            ...
            <br/><br/>
            He also wrote Flow's very <a href="https://github.com/phleet/flask_debugtoolbar_lineprofilerpanel" target="_blank">first piece of open source software!</a>
            <br/><br/>
        ...
        <ul>
          <Contributor name="Kartik Talwar" about="http://kartikt.com/" gh="KartikTalwar" />
          <Contributor name="Ted Ying" about="https://github.com/yingted" gh="yingted" />
          <Contributor name="Gabriel Wong" about="https://www.gabrielwong.net/" gh="gabrielwong" />
          <Contributor name="Konrad Listwan-Ciesielski" about="https://github.com/klistwan/" gh="klistwan" />
          <Contributor name="Andy Zhang" about="http://andyzhang.net/" gh="andyzg" />
          <Contributor name="Mario Lamontagne" about="http://andyzhang.net/" gh="mario54" />
          <Contributor name="Jeff Gulbronson" about="https://github.com/JGulbronson" gh="JGulbronson" />
          <Contributor name="Ryan De Villa" about="https://github.com/ryandv" gh="ryandv" />
          <Contributor name="Joshua Kalpin" about="https://github.com/ryandv" gh="Kapin" />
            <Contributor name="Theo Belaire" about="https://github.com/ryandv" gh="tbelaire" />
          <Contributor name="George Ke" about="https://georgeke.github.io/" gh="georgeke" />
          <Contributor name="Charles Qi" about="https://github.com/ccqi" gh="ccqi" />
          <Contributor name="Saksham Sachdev" about="https://github.com/sachdevs" gh="sachdevs" />
        </ul>
      </PageBody>
    </PageContentWrapper>
  </PageWrapper>
