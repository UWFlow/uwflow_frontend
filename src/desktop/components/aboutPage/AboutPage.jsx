    ...
    <PageBody>
      <PageContentWrapper>
        <PageBodyContent>
          ...
          <PageBodyParagraph>
            Flow is a course planning website for University of Waterloo
          ...
          <PageBodyParagraph>
            ...
            founders below. Launching Flow in 2012, they addressed a real need
            at the University: students did not have nearly enough information
            about courses to choose them. Here’s Sandy Wu (one of our founders)
            on selecting courses before Flow:
          </PageBodyParagraph>
          <PageBodyParagraph>
          ...
          <PageBodyParagraph>
            Want more? Go to
            http://david-hu.com/2014/02/28/open-sourcing-uw-flow-draft.html for
            a tale of four tenacious students and one mammoth idea.
          </PageBodyParagraph>
          <PageBodyParagraph>
            We built UW Flow 2.0 in 2019 to modernize and hone in on
            functionality you care about. As you navigate UW Flow 2.0, you’ll
            notice new features, better response times, and plenty more. What
            hasn’t changed is our commitment to the UWaterloo community and our
            drive to empower you.
          </PageBodyParagraph>
